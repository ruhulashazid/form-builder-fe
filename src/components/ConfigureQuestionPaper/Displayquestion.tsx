...
export const DisplayQuestion: React.FC<propsType> = memo(
  ({ questionIndex, question, showQuestionPaper, onChange }) => {
    return (
      <div className="d-questions" style={{ width: "100%" }}>
...
const DisplayOption: React.FC<any> = ({
  question,
  showQuestionPaper,
  onChange,
}) => {
